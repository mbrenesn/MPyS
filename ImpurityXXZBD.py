...
global_name = ('l' + str(sites) + '_impurity'
    + '_h' + str(h) + '_mu' + str(mu) + '_dop' + str(args.dop) 
    + '_chi' + str(bond_dim) + '_dt' + str(dt))
...
name = 'impurity_magnetisation_' + global_name + '.dat'
bufsize = 1
